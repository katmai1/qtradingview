...
class Ui_DialogConfig(object):
    ...
    def retranslateUi(self, DialogConfig):
        ...
        item.setText(_translate("DialogConfig", "BitFlyer"))
        ...
        item.setText(_translate("DialogConfig", "Bybit"))
        item = self.list_exchanges.item(10)
        item.setText(_translate("DialogConfig", "CexIO"))
        item = self.list_exchanges.item(11)
        item.setText(_translate("DialogConfig", "Coinbase"))
        item = self.list_exchanges.item(12)
        item.setText(_translate("DialogConfig", "Coinfloor"))
        item = self.list_exchanges.item(13)
        item.setText(_translate("DialogConfig", "Currencycom"))
        item = self.list_exchanges.item(14)
        item.setText(_translate("DialogConfig", "Deribit"))
        item = self.list_exchanges.item(15)
        item.setText(_translate("DialogConfig", "FTX"))
        item = self.list_exchanges.item(16)
        item.setText(_translate("DialogConfig", "Gemini"))
        item = self.list_exchanges.item(17)
        item.setText(_translate("DialogConfig", "HitBTC"))
        item = self.list_exchanges.item(18)
        item.setText(_translate("DialogConfig", "Kraken"))
        item = self.list_exchanges.item(19)
        item.setText(_translate("DialogConfig", "Kucoin"))
        item = self.list_exchanges.item(20)
        item.setText(_translate("DialogConfig", "Mercado"))
        item = self.list_exchanges.item(21)
        item.setText(_translate("DialogConfig", "OKCoin"))
        item = self.list_exchanges.item(22)
        item.setText(_translate("DialogConfig", "Okex"))
        item = self.list_exchanges.item(23)
        item.setText(_translate("DialogConfig", "Poloniex"))
        item = self.list_exchanges.item(24)
