...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionMarkets.setStatusTip(_translate("MainWindow", "Show/hide markets"))
        self.actionMarkets.setShortcut(_translate("MainWindow", "F1"))
        self.actionAlarms.setText(_translate("MainWindow", "Alarms"))
        self.actionAlarms.setStatusTip(_translate("MainWindow", "Show/hide alarms"))
        self.actionAlarms.setShortcut(_translate("MainWindow", "F2"))
        self.actionFull_Screen.setText(_translate("MainWindow", "Full Screen"))
        self.actionFull_Screen.setStatusTip(_translate("MainWindow", "Activate/deactivate full screen"))
        self.actionFull_Screen.setShortcut(_translate("MainWindow", "F11"))
        self.actionDebug.setText(_translate("MainWindow", "Debug"))
        self.actionDebug.setStatusTip(_translate("MainWindow", "Show/hide debug panel"))
