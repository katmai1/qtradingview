...
class Ui_DockAlarms(object):
    def setupUi(self, DockAlarms):
        ...
        self.tabla_alarms.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        ...
        self.btn_delete.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
    ...
    def retranslateUi(self, DockAlarms):
        ...
        DockAlarms.setWindowTitle(_translate("DockAlarms", "A&larms"))
        ...
        item.setText(_translate("DockAlarms", "Market"))
        ...
        item.setText(_translate("DockAlarms", "Condition"))
        item = self.tabla_alarms.horizontalHeaderItem(4)
        item.setText(_translate("DockAlarms", "Price"))
        self.btn_delete.setText(_translate("DockAlarms", "Delete alarm"))
