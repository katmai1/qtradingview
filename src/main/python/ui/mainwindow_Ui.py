...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionMarkets.setToolTip(_translate("MainWindow", "Mercados (F1)"))
        self.actionMarkets.setStatusTip(_translate("MainWindow", "Muestra/oculta panel mercados (F1)"))
        self.actionMarkets.setShortcut(_translate("MainWindow", "F1"))
        self.actionSalir.setText(_translate("MainWindow", "Salir"))
        self.actionSalir.setToolTip(_translate("MainWindow", "Salir (Control+Q)"))
        self.actionSalir.setStatusTip(_translate("MainWindow", "Sale de la aplicación (Control+Q)"))
        ...
        self.actionPantalla_completa.setToolTip(_translate("MainWindow", "Pantalla completa (F11)"))
        self.actionPantalla_completa.setStatusTip(_translate("MainWindow", "Activa/desactiva la pantalla completa (F11)"))
        ...
        self.actionDebug.setToolTip(_translate("MainWindow", "Depurar (F10)"))
        self.actionDebug.setStatusTip(_translate("MainWindow", "Muestra/oculta panel de depuración (F10)"))
        self.actionDebug.setShortcut(_translate("MainWindow", "F10"))
        self.actionAlarms.setText(_translate("MainWindow", "Alarmas"))
        self.actionAlarms.setToolTip(_translate("MainWindow", "Alarmas (F2)"))
        self.actionAlarms.setStatusTip(_translate("MainWindow", "Muestra/oculta panel alarmas (F2)"))
        self.actionAlarms.setShortcut(_translate("MainWindow", "F2"))
        self.actionConfigurar.setText(_translate("MainWindow", "Configurar"))
        self.actionConfigurar.setToolTip(_translate("MainWindow", "Configurar (F9)"))
        self.actionConfigurar.setStatusTip(_translate("MainWindow", "Muestra ventana de configuración (F9)"))
