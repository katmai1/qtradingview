...
from .db import db, crea_tablas, Markets
...
class DockMarkets(QtWidgets.QDockWidget, Ui_dock_markets):
    ...
    def _get_icon_by_symbol(self, symbol):
        if Markets.check_symbol_is_fav(symbol, self.selected_exchange):
            return QtGui.QIcon(":/base/star.svg")
        return QtGui.QIcon(":/base/voidstar.svg")
